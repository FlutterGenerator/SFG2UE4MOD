...
public class FloatingModMenuService extends Service {
    ...
    int TEXT_COLOR2 = Color.parseColor("#FFF8F8F8");
    ...
    int ICON_SIZE = 41; //Change both width and height of image
    float ICON_ALPHA = 200.7f; //Transparent
    int ToggleON = Color.WHITE;
    int ToggleOFF = Color.BLACK;
    ...
    String NumberTxtColor = "#FF010B0F";
    //********************************************************************//
...
mExpanded = new LinearLayout(this); // Menu markup (when the menu is expanded)
        ...
        gdMenuBody.setStroke(4, Color.parseColor("#FFF4F4F4")); //Set border
        mExpanded.setBackground(gdMenuBody); //Set border
        ...
        settings.setText(Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M ? "⚙️" : "\uD83D\uDD27");
        settings.setTextColor(TEXT_COLOR);
        settings.setTypeface(Typeface.DEFAULT_BOLD);
        settings.setTextSize(26.0f);
        ...
        hideBtn.setText("𝐇𝐈𝐃𝐄");
        hideBtn.setTextColor(TEXT_COLOR2);
        ...
        closeBtn.setTextColor(TEXT_COLOR2);
...
private View Button(final int featNum, final String featName) {
    ...
    private View TextField(final int featNum, final String featName, final boolean numOnly, final int maxValue) {
        ...
        LinearLayout linearLayout = new LinearLayout(this);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(MATCH_PARENT, MATCH_PARENT);
        layoutParams.setMargins(5, 5, 5, 5);//(40, 15, 40, 15);
       ...
       button.setLayoutParams(layoutParams);
       //button.setBackgroundColor(IV_THUMB);
       ...
       button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                linearLayout1.setPadding(15, 15, 15, 15);
                ...
                linearLayout1.setPadding(35, 50, 50, 35);
    ...
    private void Collapse(LinearLayout linLayout, final String text) {
        ...
        layoutParamsLL.setMargins(7, 5, 7, 5);
        ...
        final TextView textView = new TextView(this);
        textView.setBackgroundColor(CategoryBG1);
